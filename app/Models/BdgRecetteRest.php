...
class BdgRecetteRest extends Model
{
    protected $table = 'bdg_recette_rest';
    ...
    {
        return $this->belongsTo(BdgObj2::class, 'IDObj2');
    }

    public function obj3()
    {
        return $this->belongsTo(BdgObj3::class, 'IDObj3');
    }

    public function obj4()
    {
        return $this->belongsTo(BdgObj4::class, 'IDObj4');
    }

    public function obj5()
    {
        return $this->belongsTo(BdgObj5::class, 'IDObj5');
    }
